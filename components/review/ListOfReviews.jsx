...
export default function ListOfReviews({ ISBN }) {
  ...
  return (
    <div className="w-full pb-10 grid grid-cols-1 md:max-w-[700px] gap-y-6 place-content-evenly">
      <div className="text-center text-base md:text-lg 2xl:text-xl">
        <p>
      ...
      {reviews.length > 0 ? (
        <div className="flex justify-between text-xs">
          <button
            ...
            } flex items-center shrink-0 shadow-sm rounded-lg px-3 py-2 md:px-5 md:py-3 text-black`}
